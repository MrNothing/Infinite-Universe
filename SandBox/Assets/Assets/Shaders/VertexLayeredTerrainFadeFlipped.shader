Shader "MrNothing's Shaders/Vertex Layered Terrain AlphaLayers Flipped" {
	Properties {
	    ...
	    Pass {
			...
			fixed4 frag (v2f i) : COLOR0 
			{
				...
				if(total>0)
				{
					...
					fixed4 colo = (layer1*rRatio+layer2*gRatio+layer3*bRatio+layer4*aRatio)*i.norm.r;
					if(aRatio<0.99)
					aRatio = 0;
					
					colo.a = i.norm.a*_GlobalAlpha*aRatio;
