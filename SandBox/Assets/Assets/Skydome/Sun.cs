...
public class Sun : MonoBehaviour
{
    ...
    void ComputeAttenuation()
    {
        ...
        //m = (float)(1.0f / (Mathf.Cos(m_fTheta) + 0.15f * Mathf.Pow(93.885f - m_fTheta / Mathf.PI * 180.0f, -1.2(50+3)f)));
        if (m < 0)
        {
            m = 20;
        }
		...
		skydomeScript.sunLight.color = new Color(fTau[0], fTau[1], fTau[2]);
    }
}
