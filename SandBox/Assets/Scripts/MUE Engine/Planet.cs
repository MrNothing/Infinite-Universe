...
public class Planet : MonoBehaviour {
	...
	*/
	...
	void addDetail(MeshFilter filter, int vertice, Vector3 verticePos, int detail)
	{
		...
		GameObject obj = (GameObject)Instantiate(details[detail], getFragment(filter.transform.TransformPoint(verticePos)+new Vector3(Random.Range(-0.25f, 0.25f), Random.Range(-0.25f, 0.25f), Random.Range(-0.25f, 0.25f))).point, Quaternion.identity);
	...
	void addTree(MeshFilter filter, int vertice, Vector3 verticePos, int detail)
	{
		...
		GameObject obj = (GameObject)Instantiate(trees[detail], getFragment(filter.transform.TransformPoint(verticePos)).point, Quaternion.identity);
