...
public class WaterObjects : MonoBehaviour
{
	...
	public void OnWillRenderObject()
	{
		...
		{
			if( !enabled || !o.renderer || !o.renderer.sharedMaterial || !o.renderer.enabled )
				return;
			...
			m_HardwareWaterSupport = FindHardwareWaterSupport(o);
			...
			if( mode >= WaterMode.Reflective )
			{
				...
				o.renderer.sharedMaterial.SetTexture( "_ReflectionTex", m_ReflectionTexture );
			}
			...
			if( mode >= WaterMode.Refractive )
			{
				...
				o.renderer.sharedMaterial.SetTexture( "_RefractionTex", m_RefractionTexture );
			}
	...
	void Update()
	{
		foreach(GameObject o in objects)
		{
			if( !o.renderer )
				return;
			Material mat = o.renderer.sharedMaterial;
			if( mat )
			{
				...
				Vector3 waterSize = o.renderer.bounds.size;		
	...
	private WaterMode FindHardwareWaterSupport(GameObject o)
	{
		if( !SystemInfo.supportsRenderTextures || !o.renderer )
